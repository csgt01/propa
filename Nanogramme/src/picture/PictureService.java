...
public class PictureService {
   ...
   public void cluster(Node less) {
      ...
      less.getNode(sim1).setReferences(less.getNode(sim1).getReferences() + less.getNode(sim2).getReferences());
      less.getNode(sim1).setRed(less.getNode(sim1).getRed() + less.getNode(sim2).getRed());
      less.getNode(sim1).setGreen(less.getNode(sim1).getGreen() + less.getNode(sim2).getGreen());
      less.getNode(sim1).setBlue(less.getNode(sim1).getBlue() + less.getNode(sim2).getBlue());
