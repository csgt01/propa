...
/**
 * Diese Klasse kapselt einen Knoten im Octree fuer das Runterrechnen der Farben
 * in einem Bild.
 * 
 * @author cschulte
 * 
...
public class Node implements Comparable<Node> {
   ...
   /**
    * Gibt den Knoten an der Position index zurueck.
    * 
    * @param index
    *           Position
   ...
   public String toString() {
      return "Node \n{count=" + count + ", references=" + references + ", children=" + children + ", red=" + red + ", green=" + green + ", blue=" + blue + ", \nnodes=" + Arrays.toString(nodes) + "}";
   }
