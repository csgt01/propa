      ...
      for (int columnInt = 0; columnInt < riddle.getWidth(); columnInt++) {
         ...
         if (matrix[rowInt][columnInt] == '*') {
            ...
            if (blockInts.size() == 1) {
               ...
               // Wenn es keinen Block in der Spalte gibt mit derselben Farbe und
      ...
      for (int rowInt = 0; rowInt < riddle.getHeight(); rowInt++) {
         ...
         if (c != '*' && c != '-') {
            ...
            for (Block block : blocks) {
               ...
               // System.out.println("row:" + rowInt + " column:" + columnInt +
      ...
      for (int rowInt = 0; rowInt < riddle.getHeight(); rowInt++) {
         if (matrix[rowInt][columnInt] == '*') {
            ...
            if (blockInts.size() == 1) {
               ...
               // Wenn es keinen Block in der Reihe gibt mit derselben Farbe und
